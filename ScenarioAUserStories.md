...
* Does user want per-weather music to be configurable (e.g certain genre/artist for rain)
* Does client want integration with music streaming services
* Does client want import playlists from music platforms
* Does client want ads/paid music promotion
